...
#define WLAN_SSID       "INFINITUMbz6w"           // cannot be longer than 32 characters!
#define WLAN_PASS       "018c036966"
...
void setup(void)
{
  pinMode(ledAlgo, OUTPUT);
  digitalWrite(ledAlgo, LOW);
  Serial.begin(115200);
